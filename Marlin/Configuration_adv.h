 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 45        // hugo prusa värden Seconds
  #define THERMAL_PROTECTION_HYSTERESIS 15     // hugo prusa värden Degrees Celsius
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        360 // hugo prusa värden Seconds
  #define THERMAL_PROTECTION_BED_HYSTERESIS     5 // hugo prusa värden Degrees Celsius
 ...
 */
#define ADVANCED_PAUSE_FEATURE //hugo
...
/* nedan är egna definerade menu-items för uppvärmning*/
  ...
  #define USER_DESC_7 "Preheat for " PREHEAT_6_LABEL
  #define USER_GCODE_7 "M140 S" STRINGIFY(PREHEAT_6_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_6_TEMP_HOTEND)
